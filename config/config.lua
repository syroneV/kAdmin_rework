...
--- ### PED ADDON (NE PAS TOUCHER) ### ---

k.PedAddonsList = {
    {label = 'Alex-baby', model = 'Alex-baby', image = 'https://fiverr-res.cloudinary.com/videos/t_main1,q_auto,f_auto/lnmgknaq8z7wjbovozcs/make-custom-ped-for-fivem-server.png'},
    {label = 'CR7', model = 'CR7', image = 'https://img.gta5-mods.com/q95/images/cristiano-ronaldo-barak101/5f7185-Screenshot_9.png'},
    {label = 'Ped Female', model = 'babyfemale60f', image = 'https://img.gta5-mods.com/q95/images/cristiano-ronaldo-barak101/5f7185-Screenshot_9.png'}
}
...
k.props = {
    ...
    {label = 'Pallette de parpaing', model = 'prop_conc_blocks01a'},
}
